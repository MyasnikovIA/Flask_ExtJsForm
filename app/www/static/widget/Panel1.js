 ...
 * @xtype panel
 */
Ext.Panel1 = Ext.extend(Ext.Container, {
    /**
...
new Ext.Panel({
    ...
    onRender : function(ct, position){
        Ext.Panel1.superclass.onRender.call(this, ct, position);
        this.createClasses();
    ...
    addTool : function(){
        ...
        if(!this.toolTemplate){
            ...
            tt.compile();
            Ext.Panel1.prototype.toolTemplate = tt;
        }
    ...
    onShow : function(){
        ...
        Ext.Panel1.superclass.onShow.call(this);
    },
    ...
    onHide : function(){
        ...
        Ext.Panel1.superclass.onHide.call(this);
    },
    ...
    afterRender : function(){
        ...
        Ext.Panel1.superclass.afterRender.call(this); // do sizing calcs last
        this.initEvents();
    },
    ...
    initDraggable : function(){
         ...
         * @property dd
         */
        this.dd = new Ext.Panel1.DD(this, Ext.isBoolean(this.draggable) ? null : this.draggable);
    },
    ...
    onDisable : function(){
        ...
        Ext.Panel1.superclass.onDisable.call(this);
    },
    ...
    onEnable : function(){
        ...
        Ext.Panel1.superclass.onEnable.call(this);
    },
    ...
    onResize : function(w, h){
        ...
        this.syncShadow();
        Ext.Panel1.superclass.onResize.call(this);
    },
...
panel.load({
    ...
    beforeDestroy : function(){
        Ext.Panel1.superclass.beforeDestroy.call(this);
        if(this.header){
